...
```bash
arch -arm64 ./forge_build_env/bin/python3 -m nuitka --standalone --onefile --onefile-no-strip -o binary/forge-arm64 main.py
```
...
arch -x86_64 ./forge_build_env_x86/bin/python3 -m nuitka --standalone --onefile --onefile-no-strip -o binary/forge-x86_64 main.py
```
